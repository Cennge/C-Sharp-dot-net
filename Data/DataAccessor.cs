...
namespace csharp_all.Data
{
    ...
    internal class DataAccessor
    {
        ...
        public DataAccessor()
        {
            String connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\ilya\Downloads\csharp-all\Database1.mdf;Integrated Security=True";
        ...
        public IEnumerable<ProdSaleModel> Top3DailyProducts(CompareMode compareMode)
        {
            ...
            if (compareMode == CompareMode.ByQuantity)
            {
                sql = @$"
                    ...
                    FROM
	                    tbl_Sales S
	                    JOIN tbl_Products P ON S.ProductId = P.Id
                    WHERE
        ...
        {
            return ExecuteScalar<Product>("SELECT TOP 1 * FROM tbl_Products ORDER BY NEWID()");
        }
        public Department RandomDepartment()
        {
            return ExecuteScalar<Department>("SELECT TOP 1 * FROM tbl_Departments ORDER BY NEWID()");
        }
        public Manager RandomManager()
        {
            return ExecuteScalar<Manager>("SELECT TOP 1 * FROM tbl_Managers ORDER BY NEWID()");
        }

        public List<Product> GetProducts()
        {
            return ExecuteList<Product>("SELECT * FROM tbl_Products");
        }
        public List<Department> Gettbl_Departments()
        {
            return ExecuteList<Department>("SELECT * FROM tbl_Departments");
        }
        public List<Manager> GetManagers()
        {
            return ExecuteList<Manager>("SELECT * FROM tbl_Managers");
        }
        public List<tbl_News> Gettbl_News()
        {
            return ExecuteList<tbl_News>("SELECT * FROM tbl_News");
        }
        ...
        public IEnumerable<Department> Enumtbl_Departments()
        {
        ...
        {
            String sql = "SELECT * FROM tbl_Managers";
            using SqlCommand cmd = new(sql, connection);
            SqlDataReader? reader;
            try
            {
        ...
        {
            String sql = "CREATE TABLE tbl_Sales(" +
        ...
        {
            String sql = "CREATE TABLE tbl_Managers(" +
                "Id           UNIQUEIDENTIFIER PRIMARY KEY," +
        ...
        private void Installtbl_Departments()
        {
            String sql = "CREATE TABLE tbl_Departments(" +
                "Id    UNIQUEIDENTIFIER PRIMARY KEY," +
                "Name  NVARCHAR(64)     NOT NULL)";
            using SqlCommand cmd = new(sql, connection);
            try
        ...
        {
            String sql = "CREATE TABLE tbl_Products(" +
                "Id    UNIQUEIDENTIFIER PRIMARY KEY," +
                "Name  NVARCHAR(64)     NOT NULL," +
        ...
        private void Installtbl_News()
        {
            String sql = "CREATE TABLE tbl_News(" +
                "Id    UNIQUEIDENTIFIER PRIMARY KEY," +
        ...
        private void Installtbl_Accesses()
        {
            String sql = "CREATE TABLE tbl_Access(" +
                "Id    UNIQUEIDENTIFIER PRIMARY KEY," +
                "ManagerId    UNIQUEIDENTIFIER NOT NULL," +
        ...
        {
            String sql = "INSERT INTO tbl_Managers VALUES" +
        ...
        private void Seedtbl_Departments()
        {
            String sql = "INSERT INTO tbl_Departments VALUES" +
        ...
        private void Seedtbl_Accesses()
        {
            String sql = "INSERT INTO tbl_Access VALUES" +
        ...
        {
            String sql = "INSERT INTO tbl_Sales(Id, ManagerId, ProductId, Quantity, Moment) VALUES" +
                "( NEWID(), " +
                " (SELECT TOP 1 Id FROM tbl_Managers ORDER BY NEWID()), " +
                " (SELECT TOP 1 Id FROM tbl_Products ORDER BY NEWID()), " +
        ...
        public List<SaleModel> MonthlySalesByManagersOrm(int month, int year = 2025)
        {
            return ExecuteList<SaleModel>(@$"
                        ...
                        FROM
	                        tbl_Sales S
	                        JOIN tbl_Managers M ON S.ManagerId = M.Id
                        WHERE
	                        Moment BETWEEN @date AND DATEADD(MONTH, 1, @date)
                        GROUP BY
	                        M.Id
        ...
        {
            String sql = $"SELECT COUNT(*) FROM tbl_Sales WHERE Moment BETWEEN @date AND DATEADD(MONTH, 1, @date)";
            using SqlCommand cmd = new(sql, connection);
